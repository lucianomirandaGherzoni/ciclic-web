  ...
  return (
    <section id="about" ref={sectionRef} className="about-section bg-primary-black px-4 py-16 md:py-24">
      <div className="about-container mx-auto max-w-[1100px]">
        ...
        <div className="about-content relative mb-[22rem] md:mb-0">
          ...
          <div className="about-text absolute inset-x-0 top-[48%] z-10 mx-auto w-[92%] rounded-container bg-secondary-black p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] sm:p-8 md:inset-x-auto md:-right-10 md:top-1/2 md:mx-0 md:w-[68%] md:-translate-y-1/2 md:p-10">
